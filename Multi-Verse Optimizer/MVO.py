...
class MVO:
    def __init__(self, N=50, Max_time=100, lb=-5, ub=5, dim=0, fobj='bentCigar'):
        self.N = N
    ...
    def optimize(self):
        ...
        while Time < self.Max_time + 1:
            ...
            if Time % 50 == 0:
                print(f'At iteration {Time} the best universes fitness is {Best_universe_Inflation_rate}')
    ...
    def optimize_tsp(self, problem):
        ...
        # Initialize the positions of universes
        Universes = self.utils.initialization(self.N, dim, self.ub, self.lb)
        ...
        return Best_universe_Inflation_rate, Bsol, Convergence_curve